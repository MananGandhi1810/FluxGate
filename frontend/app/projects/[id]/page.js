  ...
  return (
    <div className="container mx-auto p-4 space-y-6">
      <div className="flex justify-between items-center">
        ...
        <Badge
          ...
          className={`text-sm capitalize ${
            projectData.status === "running" ? "bg-green-400" : "bg-red-400"
          }`}
        >
      ...
      <div className="flex space-x-4">
        ...
        <Button onClick={handleStopProject} className="bg-red-500 text-white">
          Stop Project
        </Button>
      </div>
      ...
      <Card className="mt-6">
        ...
        <CardContent className="h-64 overflow-y-scroll">
          {buildLogs.length > 0 ? (
            ...
            <p className="text-sm text-gray-500">No build logs available.</p>
          )}
        </CardContent>
      </Card>
