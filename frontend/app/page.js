...
import { PlusCircle, Box, Moon, Sun, X, Upload } from "lucide-react";
...
export default function Dashboard() {
  ...
  const removeEnvSecret = (index) => {
    const updatedSecrets = formData.envSecrets.filter((_, i) => i !== index);
    setFormData({ ...formData, envSecrets: updatedSecrets });
  };
      ...
      const response = await axios.post(
        "http://localhost:3000/project/new",
        {
          ...
          envSecrets: Object.fromEntries(
            formData.envSecrets.map(({ key, value }) => [key, value])
          ),
        },
              ...
              <DialogContent className="sm:max-w-[600px]">
                ...
                <div className="grid gap-4 py-4">
                  ...
                  <div className="grid grid-cols-4 items-start gap-4">
                    <Label className="text-right mt-2">Env Secrets</Label>
                      ...
                      <Tabs defaultValue="manual" className="w-full">
                        ...
                        <TabsContent value="file">
                          <div className="space-y-2">
                            ...
                            />
                            <Button onClick={parseEnvFile} className="w-full">
